...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(error                          ((,class (:foreground ,red-3 :underline (:color foreground-color :style wave)))))
   `(warning                        ((,class (:foreground ,orange-3 :underline (:color foreground-color :style wave)))))
   `(success                        ((,class (:foreground ,cham-3))))
   ;; Company faces
   ;`(company-echo                      ((,class (:foreground , :background ,))))
   `(company-echo-common               ((,class (:background ,orange-3))))
   `(company-tooltip                   ((,class (:background ,choc-1))))
   `(company-tooltip-selection         ((,class (:background ,blue-1))))
   `(company-tooltip-mouse             ((,class (:background ,alum-3))))
   `(company-tooltip-common            ((,class (:background ,choc-1 :foreground ,red-3))))
   `(company-tooltip-common-selection  ((,class (:background ,blue-1 :foreground ,red-3))))
   `(company-preview                   ((,class (:background ,blue-1))))
   `(company-preview-common            ((,class (:background ,blue-1 :foreground ,alum-1))))
   `(company-preview-search            ((,class (:background ,plum-1))))
   ;; Font lock faces
   `(font-lock-builtin-face         ((,class (:foreground ,viol-3))))
   `(font-lock-comment-face         ((,class (:slant italic :foreground ,alum-4))))
   `(font-lock-constant-face        ((,class (:weight light :foreground ,orange-3))))
   `(font-lock-doc-face             ((,class (:inherit font-lock-comment-face :foreground ,alum-5 :background ,alum-1))))
   `(font-lock-function-name-face   ((,class (:foreground ,red-2))))
   `(font-lock-keyword-face         ((,class (:foreground ,blue-2))))
   `(font-lock-string-face          ((,class (:foreground ,cham-3))))
   `(font-lock-type-face            ((,class (:inherit font-lock-keyword-face :weight bold))))
   `(font-lock-variable-name-face   ((,class (:foreground ,choc-3))))
   `(font-lock-warning-face         ((,class (:underline (:color ,red-1 :style wave)))))
   ...
   `(outline-2                      ((,class (:foreground ,choc-3 :weight bold))))
   `(outline-3                      ((,class (:foreground ,plum-3 :weight bold))))
   `(outline-4                      ((,class (:foreground ,orange-3 :weight bold))))
   `(outline-5                      ((,class (:foreground ,choc-3 :weight bold))))
   `(outline-6                      ((,class (:foreground ,red-3 :weight bold))))
   `(outline-7                      ((,class (:foreground ,cham-3 :weight bold))))
